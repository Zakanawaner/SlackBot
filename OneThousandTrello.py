...
class Trello:
    def __init__(self, token, api_key):
        ...
        self.get_organization = 'https://api.trello.com/1/organizations/{id}'
    ...
    def delete_board(self, board_id):
        requests.post(self.delete_board_url.format(board_id), params=self.query)

    def create_board(self, board_name):
        requests.post(self.create_board_url, params={'key': self.query['key'], 'token': self.query['token'], 'name': board_name})